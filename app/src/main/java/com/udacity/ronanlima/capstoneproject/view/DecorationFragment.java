...
public class DecorationFragment extends Fragment implements ProjectAdapter.OnProjectClickListener {
    ...
    private void configProjectAdapter(@Nullable List<Project> projects) {
        List<Project> listDecoration = mountArchitecureList(projects);
        shimmerRecyclerView.hideShimmerAdapter();
        if (!listDecoration.isEmpty() && adapter != null) {
            adapter.setList(listDecoration);
        } else {
    ...
    private List<Project> mountArchitecureList(@Nullable List<Project> projects) {
        ...
        for (Project p : projects) {
            if (p.getIdProposito().equals(Proposito.DECORACAO.getId())) {
